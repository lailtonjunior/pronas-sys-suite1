...
echo "🧠 ADICIONANDO CAMADA INTELIGENTE DE REESCRITA"
echo "═══════════════════════════════════════════════════════════════"
echo ""

cd /root/pronas-sys-suite1

cat > backend/app/ai/agents/text_agent.py << 'INTELLIGENT'
...
echo "✅ Agente inteligente com reescrita contextual configurado"
...
RESP=$(curl -s -X POST http://localhost:8000/api/ai/suggest \
  ...
  -d '{
    ...
    "field_context": {},
    "project_context": {
      "title": "AMPLIAÇÃO E QUALIFICAÇÃO DOS ATENDIMENTOS EM FISIOTERAPIA",
...
echo "   • Reescrito: $(echo "$RESP" | jq -r '.rewritten // "false"')"
echo "   • Confiança: $(echo "$RESP" | jq -r '.confidence')"

echo ""
echo "📄 SUGESTÃO GERADA:"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "$RESP" | jq -r '.suggestion' | fold -w 70 -s | head -50
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

echo ""
echo "═══════════════════════════════════════════════════════════════"
echo "🎉 AGORA A IA REESCREVE CONTEXTUALIZADAMENTE!"
echo "═══════════════════════════════════════════════════════════════"
echo ""
echo "✨ O sistema agora:"
echo "   1️⃣ Lê o título: 'AMPLIAÇÃO E QUALIFICAÇÃO...'"
echo "   2️⃣ Busca casos similares (RAG)"
echo "   3️⃣ REESCREVE adaptado ao SEU contexto"
echo "   4️⃣ Menciona especificidades da sua instituição"
echo "   5️⃣ Mantém coerência com campos preenchidos"
echo ""
echo "🚀 Se Gemini funcionar: texto 100% personalizado"
echo "📚 Se não: exemplos + orientações específicas"
echo ""
